export default {
  ...
  reportCards: {
    ...
    createBulkReportCards: 'Create Class Report Cards (Bulk)',
    createReportCardClass: 'Create Report Cards for Class',
    selectHomeroomClass: 'Select your homeroom class. This will generate report cards for all students in this class for the selected period.',
    bulkReportCardsCreated: 'Successfully created {{count}} report cards.',
    noHomeroomClassNote: 'You are not assigned as a homeroom teacher for any class in this period.',
    noStudentsInClass: 'No students found in the selected class.',
