...
import { useCourseMaterials, getMaterialUrl } from '@/hooks/useCourseMaterials';
import { FileText, Loader2, File, Video, FileImage, Download, ExternalLink } from 'lucide-react';
    ...
    <div className="space-y-8 animate-fade-in">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Access lesson materials from your courses
        </p>
      </div>
