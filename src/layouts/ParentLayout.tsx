/**
 * @fileoverview Parent Layout Component
 * @description Main layout for parent dashboard with sidebar navigation
 */
...
const ParentLayout = () => {
    ...
    const navigation = [
        { name: t('nav.dashboard'), href: '/parent', icon: Home },
        { name: t('parent.addChild'), href: '/parent/add-child', icon: UserPlus },
                                ...
                                <DropdownMenuTrigger asChild>
                                    <Button variant="ghost" className="flex items-center gap-3 h-auto py-2">
                                        ...
                                        <div className="hidden md:block text-left">
                                            <p className="text-sm font-medium text-foreground">{profile?.name || t('auth.parent')}</p>
